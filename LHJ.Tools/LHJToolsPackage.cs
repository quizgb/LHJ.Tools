//------------------------------------------------------------------------------
// <copyright file="LHJToolsPackage.cs" company="Company">
...
namespace LHJ.Tools
{
    ...
    [Guid(LHJToolsPackage.PackageGuidString)]
    ...
    public sealed class LHJToolsPackage : Package
    {
        ...
        /// </summary>
        public const string PackageGuidString = "35906932-eb77-48aa-93a8-bf56cd4affc3";

        /// <summary>
        /// Initializes a new instance of the <see cref="LHJToolsPackage"/> class.
        /// </summary>
        public LHJToolsPackage()
        {
        ...
        protected override void Initialize()
        {
            ...
            LHJ.Tools.SetPrjLocalCopyFalseMenu.Initialize(this);
        }
